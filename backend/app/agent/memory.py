...
async def load_session_intro(user_id: int) -> SystemMessage:
    ...
    async with async_session() as session:
        ...
        content = (
            ...
            f"Never guess a product_id for manage_cart from memory or a name alone — if you don't have "
            f"the exact id from a search_products result earlier in this conversation, call "
            f"search_products again to resolve it first.\n"
